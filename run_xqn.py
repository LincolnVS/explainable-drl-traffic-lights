...
parser.add_argument('--log_dir', type=str, default="log/xqn", help='directory in which logs should be saved')
parser.add_argument('--info_file', type=str, default="agent/configs_xqn/default.json", help='path to the file with informations about the model')
